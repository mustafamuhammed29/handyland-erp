...
export default async function PrintTicketPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const data: Record<string, string> = {
    ...
    "{{time_30min}}": repair.repairTimeEstimate === "30min" ? "checked" : "",
    "{{time_45min}}": repair.repairTimeEstimate === "45min" ? "checked" : "",
    "{{time_1h}}": repair.repairTimeEstimate === "1h" ? "checked" : "",
    "{{time_1_5h}}": repair.repairTimeEstimate === "1.5h" ? "checked" : "",
    "{{time_2h}}": repair.repairTimeEstimate === "2h" ? "checked" : "",
    "{{time_2_5h}}": repair.repairTimeEstimate === "2.5h" ? "checked" : "",
    "{{time_3h}}": repair.repairTimeEstimate === "3h" ? "checked" : "",
    "{{time_4h}}": repair.repairTimeEstimate === "4h" ? "checked" : "",
